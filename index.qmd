...
ggplot(data = japan) +
  ...
  theme_midr(grid = "xy") +
  theme(legend.key.height = unit(55, "pt"))
```
...
-   **Viridis パレット**
    ...
    現在、データサイエンスの世界で最も推奨されている順序パレットの一つです。色の変化が人間の目にとって「数値の変化」と等しく感じられるよう数学的に設計されています。色覚多様性への配慮という観点からも推奨されています。
